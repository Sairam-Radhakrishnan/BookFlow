...
print("                             BookFlow   A Library Management System                                   ")
print("By Sairam.R ")
print("")
print("                                     Hello from BookFlow 📚             ")
...
if Stdorteach.lower() == 'student':
    ...
    userid_dict = {"sairam":1,"user2":2}
    username_list = ["sairam","user2"]
    password_list = ["sairam@abcd","user2@abcd"]
...
# Asking the user to select an option using input statement
            ...
            if response ==1:
                ...
                print("The Book Catalogue in BookFlow!")
                ...
                plt.title("Popular Books loved by users of BookFlow!")
                plt.xlabel("Book Name")
                plt.ylabel("Votes")
                plt.show()
            elif response == 5:
                print("Thanks for using BookFlow!")
                break
